...
Hyperboloid* Hyperboloid::Create ( const Transform *o2w , const Transform *w2o , bool reverseOrientation , Parameter* params ) {
    Point p1 = *params->getPoint ( "p1" , Point(0,0,0) ) ;
    Point p2 = *params->getPoint ( "p2" , Point(1,1,1) ) ;
    float phimax = params->getFloat ("phimax" , 360 ) ;
    Hyperboloid* hyperboloid = new Hyperboloid ( o2w , w2o , reverseOrientation , p1 , p2 , phimax ) ;
	return hyperboloid ;
}
